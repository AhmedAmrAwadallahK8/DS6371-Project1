...
ase2 = get_ase(Predictions, Val2$Life.expectancy)
ase2
AIC(linearModel2)
...
ase3 = get_ase(Predictions, Val3$Life.expectancy)
ase3
AIC(linearModel3)
...
ase4 = get_ase(Predictions, Val4$Life.expectancy)
ase4
AIC(linearModel4)
...
ase5 = get_ase(Predictions, Val5$Life.expectancy)
ase5
AIC(linearModel5)

#Compare all models using multiple train validation splits to average out randomness
#Var Setup
modelIterations = 500 #Takes Awhile depending on how large this number is
aseModel1 = 0
aseModel2 = 0
aseModel3 = 0
aseModel4 = 0
